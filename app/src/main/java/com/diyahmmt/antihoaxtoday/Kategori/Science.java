...
public class Science extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterNews = new AdapterNews(Science.this, list);
        ...
        api.getListNews("id", category, BuildConfig.NEWS_API_TOKEN).enqueue(new Callback<ResponseNews>() {
            ...
            public void onResponse(Call<ResponseNews> call, Response<ResponseNews> response) {
                if (response.isSuccessful()) {
                    ...
                    news.setAdapter(new AdapterNews(Science.this, list));
            ...
            public void onFailure(Call<ResponseNews> call, Throwable t) {
                hideDialog();
                Toast.makeText(Science.this, "Cek Koneksi Internet Anda !! ", Toast.LENGTH_SHORT).show();
            }
        });
    }
